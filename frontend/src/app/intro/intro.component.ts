...
export class IntroComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.intro_3 = this.mongodbService.getLocaleValue("Do your best to pick the answer that best matches your agreement with the statement. If you are unable to pick a response that matches, choose <b>\"<u>I don't know</u>\".</b>");
